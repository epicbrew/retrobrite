...
nestest:
    # Run retrobrite
    #-RUST_LOG=debug cargo run -- --trace-cpu --pc 49152 -c 26555 nestest/nestest.nes > retrobrite.log 2>&1
    cargo run -- --trace-cpu --pc 49152 -c 26555 nestest/nestest.nes > retrobrite.log 2>&1
